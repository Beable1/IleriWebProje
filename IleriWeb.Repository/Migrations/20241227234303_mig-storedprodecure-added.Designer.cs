...
namespace IleriWeb.Repository.Migrations
{
    ...
    [Migration("20241227234303_mig-storedprodecure-added")]
    partial class migstoredprodecureadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IleriWeb.Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasTrigger("user_created_trigger");
                        });
                });

            modelBuilder.Entity("IleriWeb.Core.Models.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IleriWeb.Core.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IleriWeb.Core.Models.BasketItem", b =>
                {
                    b.HasOne("IleriWeb.Core.Models.Basket", "Basket")
                        .WithMany("Items")
